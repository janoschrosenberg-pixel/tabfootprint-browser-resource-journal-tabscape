...
<div align="center">
  <img src="./public/logo.svg" alt="TabFootprint — Desktop browsers — Tabscape" width="64" height="64">
  <h1>TabFootprint — Desktop browsers — Tabscape</h1>
</div>

Сравнение ресурсов браузера по собственным замерам без чтения истории и паролей.
...
- **Tab workload manifest** — запланированный модуль; реализации нет.
- **Extension experiment notes** — запланированный модуль; реализации нет.
- **Memory sample comparisons** — запланированный модуль; реализации нет.
...
3. Опишите один контрольный сценарий для **Tab workload manifest**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TabFootprint — Desktop browsers — Tabscape — specification review workflow">
<br>
...
Зафиксируйте входные данные и ожидаемый результат для модуля 1. Запишите версию Desktop browsers, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Extension experiment notes

Зафиксируйте входные данные и ожидаемый результат для модуля 2. Запишите версию Desktop browsers, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Memory sample comparisons

Зафиксируйте входные данные и ожидаемый результат для модуля 3. Запишите версию Desktop browsers, условия сценария и известные ограничения. Выполнение этих действий вручную не подтверждает наличие автоматизированного инструмента.

### Кратко

| Поле | Значение |
|---|---|
| Продукт или область | Desktop browsers |
| Категория | Утилиты для ПК |
| Входные данные | Ручные записи или разрешенный пользователем локальный экспорт |
| Планируемый результат | Tab workload manifest |
